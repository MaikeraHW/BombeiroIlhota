...
<head>
    ...
    <title>Home - Bombeiros Voluntários de Ilhota</title>
</head>
<body class="body">
        ...
        <div class="slides">
            ...
            <div class="slide active">
                <div class="peliculaHolder">
                    <img src="/src/pic1.jpg" alt="Slide 1">
            ...
            <div class="slide">
                <div class="peliculaHolder">
                    <img src="/src/pic3.jpg" alt="Slide 2" class="adjust">
            ...
            <div class="slide">
                <div class="peliculaHolder">
                    <img src="/src/pic2.jpeg" alt="Slide 3" class="adjust2">
            ...
            <div class="slide">
                <div class="peliculaHolder">
                    ...
                    <img src="/src/pic4.jpg" alt="Slide 4" class="adjust3">
                    <h2 class="banner4Text">Prontos para<br>salvar vidas</h2>
                </div>
            </div>
                ...
                <div class="homeStatisticsHolder">
                    <div class="homeStatisticsInside">
                        <div class="homeStatisticItem topLeft">
                            ...
                            <img src="/src/icons/paramedic.png" alt="">
                            </div>
                        ...
                        <div class="homeStatisticItem topRight">
                            <div class="iconHolder">
                            <img src="/src/icons/traffic.png" alt="">
                            </div>
                            <div class="itemContent">
                    ...
                    <div class="homeStatisticsInside">
                        <div class="homeStatisticItem bottomLeft">
                            <div class="iconHolder">
                            <img src="/src/icons/firefighter.png" alt="">
                            </div>
                            <div class="itemContent">
                        ...
                        <div class="homeStatisticItem">
                            <div class="iconHolder">
                            <img src="/src/icons/fire-brigade.png" alt="">
                            </div>
                            <div class="itemContent">
...
<?php endif; ?>
                        ...
                        <article class="news-card">
                            <div class="news-date">05/06/2026</div>
                            <h3 class="news-title">Nova viatura é incorporada à frota</h3>
                        </article>

                        <article class="news-card">
                            <div class="news-date">05/06/2026</div>
                            <h3 class="news-title">Simulado de evacuação em escola</h3>
                        </article>

                        <article class="news-card">
                            <div class="news-date">05/06/2026</div>
                            <h3 class="news-title">Capacitação em primeiros socorros</h3>
                        </article>
